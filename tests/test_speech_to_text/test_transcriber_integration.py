...
class TestWhisperTranscriberIntegration:
    ...
    @pytest.mark.integration
    @pytest.mark.asyncio
    async def test_transcribe_short_sentence(
    ...
    @pytest.mark.integration
    @pytest.mark.asyncio
    async def test_transcribe_very_short_audio(
        self, transcriber: WhisperTranscriber
    ) -> None:
    ...
    @pytest.mark.integration
    @pytest.mark.asyncio
    async def test_transcribe_high_quality_audio(
        self, transcriber: WhisperTranscriber
    ) -> None:
        ...
        assert len(result.strip()) > 0, (
            "Expected non-empty transcription for high quality audio"
        )

    @pytest.mark.integration
    @pytest.mark.asyncio
    async def test_transcribe_low_quality_audio(
        self, transcriber: WhisperTranscriber
    ) -> None:
    ...
    @pytest.mark.integration
    @pytest.mark.asyncio
    async def test_transcribe_command_audio(
        self, transcriber: WhisperTranscriber
    ) -> None:
    ...
    @pytest.mark.integration
    @pytest.mark.asyncio
    async def test_transcribe_question_audio(
        self, transcriber: WhisperTranscriber
    ) -> None:
    ...
    @pytest.mark.integration
    @pytest.mark.asyncio
    async def test_transcribe_dictation_audio(
        self, transcriber: WhisperTranscriber
    ) -> None:
    ...
    @pytest.mark.integration
    @pytest.mark.asyncio
    async def test_model_availability_with_real_model(
        self, transcriber: WhisperTranscriber
    ) -> None:
        ...
        if not available:
            pytest.skip(
                "Whisper model not available - this is expected in CI environments"
            )
    ...
    @pytest.mark.integration
    @pytest.mark.asyncio
    async def test_model_info_with_real_model(
        self, transcriber: WhisperTranscriber
    ) -> None:
    ...
    @pytest.mark.integration
    @pytest.mark.asyncio
    async def test_transcription_performance(
        self, transcriber: WhisperTranscriber
    ) -> None:
    ...
    async def test_multiple_transcriptions(self, transcriber: WhisperTranscriber) -> None:
        ...
        files = [TEST_AUDIO_DIR / "hello_world.wav", TEST_AUDIO_DIR / "numbers.wav"]

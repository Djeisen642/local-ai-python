...
class TestWhisperTranscriberWithResult:
    ...
    @pytest.mark.asyncio
    async def test_transcribe_audio_with_result_success(self, transcriber: WhisperTranscriber) -> None:
    ...
    @pytest.mark.asyncio
    async def test_transcribe_audio_with_result_empty_input(self, transcriber: WhisperTranscriber) -> None:
    ...
    @pytest.mark.asyncio
    async def test_transcribe_audio_with_result_invalid_input(self, transcriber: WhisperTranscriber) -> None:
    ...
    @pytest.mark.asyncio
    async def test_transcribe_audio_with_result_large_audio(self, transcriber: WhisperTranscriber) -> None:
    ...
    @pytest.mark.asyncio
    async def test_transcribe_audio_with_result_model_unavailable(self, transcriber: WhisperTranscriber) -> None:
    ...
    @pytest.mark.asyncio
    async def test_transcribe_audio_with_result_conversion_failure(self, transcriber: WhisperTranscriber) -> None:
    ...
    @pytest.mark.asyncio
    async def test_transcribe_audio_with_result_timeout_error(self, transcriber: WhisperTranscriber) -> None:
    ...
    @pytest.mark.asyncio
    async def test_transcribe_audio_with_result_memory_error(self, transcriber: WhisperTranscriber) -> None:
    ...
    @pytest.mark.asyncio
    async def test_transcribe_audio_with_result_multiple_segments(self, transcriber: WhisperTranscriber) -> None:
    ...
    @pytest.mark.asyncio
    async def test_transcribe_audio_with_result_no_confidence_data(self, transcriber: WhisperTranscriber) -> None:

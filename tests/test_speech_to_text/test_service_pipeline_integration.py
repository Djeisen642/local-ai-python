...
class TestServicePipelineIntegration:
    ...
    def test_handler_registration_and_unregistration(self) -> None:
        ...
        # Unregister handlers
        assert service.unregister_processing_handler("embedding", "test_embedding") is True
        assert service.unregister_processing_handler("response_generation", "test_response") is True

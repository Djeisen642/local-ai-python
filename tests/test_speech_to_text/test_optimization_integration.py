...
from local_ai.speech_to_text.optimization import (
...
class TestOptimizationIntegration:
    ...
    def test_optimized_config_generation(self) -> None:
        ...
        assert (
            latency_config["processing_interval"]
            <= configs["balanced"]["processing_interval"]
        )
    ...
    def test_optimization_target_effects(self) -> None:
        ...
        assert (
            latency_config["processing_interval"]
            <= accuracy_config["processing_interval"]
        )
        ...
        assert (
            accuracy_config["max_silence_duration"]
            >= latency_config["max_silence_duration"]
        )
